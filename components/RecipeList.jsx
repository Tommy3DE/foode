...
const RecipeList = ({recipes, type}) => {
    // console.log(recipes)
  return (
    <div className="bg-[url('../public/menubg.jpeg')] bg-contain h-auto" >
    <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 p-5">
        {recipes.map((recipe, index)=>{
            ...
            <div key={index} className='rounded overflow-hidden bg-slate-200 text-center'>
                <Image src={recipe.strMealThumb} width={500} height={500} alt={recipe.strMeal} className='m-auto sm:py-4 lg:py-0'/>
                <div className='p-5'>
